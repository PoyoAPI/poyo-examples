...
Sample output: [PoYo model page sample](https://storage.poyo.ai/gpt-image-2/gpt-image-2-example-1_1.png).

This is an official PoYo model page sample, not a file generated by this quickstart run.
